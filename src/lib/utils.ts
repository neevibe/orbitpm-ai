...
/** Canonical lowercase department key — re-exported from the single source of
 *  truth so the server, the permission check and the UI cannot drift apart. */
export { deptKey, sameDept, deptDisplayName } from './dept-key';
